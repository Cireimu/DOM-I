...
aTag.innerText = 'Upcoming'
aNav.href = ''
aNav.append(aTag)
aTag.style.color = 'green'

const aTag2 = document.createElement('a')
const aNav2 = document.querySelector('nav')
aTag2.innerText = 'Reviews'
aNav.href = ''
aNav2.append(aTag2)
...
let headingImg = document.querySelector('#cta-img');
...
mainContent[1].querySelector('p').textContent = siteContent['main-content']
['about-content']
